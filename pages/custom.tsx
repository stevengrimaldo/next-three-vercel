...
class Custom extends Component {
  ...
  initGUI(plane) {
    ...
    gui.add(plane.material.uniforms.amplitude, 'value', 1, 10).name('amplitude')
  ...
  updateIntersected() {
    ...
    const n = this.raycaster.intersectObject(this.plane, false, this.intersects)
